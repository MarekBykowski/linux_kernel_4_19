...
void smc_call_v11_psci_v11_query_if_memprotect_is_enabled(void *args);
void smc_call_v11_psci_v11_query_if_mem_reset2_is_enabled(void *args);
...
/* Retrieve the implemented version of the SMCCC from PSCI services.
 * It is the safest way to retrive this as compatible with the system not
...
void smc_call_v10_smccc_ver_from_psci_feature(void *arg)
{
	...
	if (res.a0 != PSCI_RET_NOT_SUPPORTED) {
		arm_smccc_smc(ARM_SMCCC_VERSION_FUNC_ID, 0, 0, 0, 0, 0, 0, 0, &res);
	}
	end = ktime_get();
